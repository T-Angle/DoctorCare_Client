    ...
    <div className="Appointment">
      ...
      <BrowserRouter>
        {currentPath == "/" ? (
          ...
          <Navigation id={id} tellCurrentPath={getCurrentPath} />
        )}
        <Switch>
          <Route exact path={baseURL + id + "/"} component={Examination} />
          <Route
            exact
            path={baseURL + id + "/tests"}
            render={(props) => <DevTestsPage {...props} />}
          />
          <Route
            exact
            path={baseURL + id + "/treatment"}
            render={(props) => <DevTreatmentPage {...props} />}
          />
        </Switch>
      </BrowserRouter>
    </div>
